...
private[ml] trait GCForestParams extends HasSeed {
  ...
  final val newFeatures: Param[String] = new Param[String](this, "newFeatures", "new features file name")
  setDefault(newFeatures -> "xx")
  def setNewFeatures(value: String): this.type = set(newFeatures, value)


  final val dataset: Param[String] = new Param[String](this, "dataset", "dataset name")
  setDefault(dataset -> "xx")
